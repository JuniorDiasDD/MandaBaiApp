...
class InfoApp extends StatefulWidget {
  ...
  @override
  State<InfoApp> createState() => _InfoPageState();
}

class _InfoPageState extends State<InfoApp> {
  ...
  Widget build(BuildContext context) {
    return BasePage(
      title:  AppLocalizations.of(context)!.info_app_title,
      body: Column(
        children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () => Navigator.pushNamed(context, '/infoMandaBai'),
                      ),
                    ),
                  ),
                  SizedBox(height: Get.height * 0.02),
