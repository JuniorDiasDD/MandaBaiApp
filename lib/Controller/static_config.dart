...
const String categoriasSaoNicolau =
    linkSaoNicolau + "products/categories?" + key;
const String categoriasSaoVicente =
    linkSaoVicente + "products/categories?" + key;
